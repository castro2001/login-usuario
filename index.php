...
//registra la informacion de los usuarios 1 parte 
if (isset($_POST["registrar"])) {
	...
	// usamos sha1 para ver si esta correcta la contraseañ;
	$password_encriptada= sha1($password);
	...
	// declarar si fila es mayor a cero 
	if ($filas > 0) {
		echo "<script>
		...
		// isertamos la informacion  usuario
		$sqlusuario = "INSERT INTO usuarios(nombre,correo,usuario,password)
			VALUE('$nombre' ,'$correo', '$usuario', '$password_encriptada')";
